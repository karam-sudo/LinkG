                            ...
                            <div class="tab-content">
                                <div class="tab-pane  active show" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <form method="post" action="{{route('Upload_project_attachment')}}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="project_name" value="{{Str::slug($Projects->getTranslation('Name','en'))}}">
                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            <tbody>
                                                @foreach($Projects->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <button class="btn btn-info btn-sm">
                                                            <?php $projectsname=Str::slug($attachment->imageable->getTranslation('Name','en')) ?> 
                                                            <a 
                                                               href="{{url('Download_service_attachment')}}/{{$projectsname}}/{{$attachment->filename}}">
                                                ...
                                                @include('pages.Projects.Delete_img')
                                                @endforeach
                                            </tbody>
                                        </table>
                                    </div>
