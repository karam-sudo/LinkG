...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0"> /{{ trans('Users_trans.user_permission') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <div class="d-flex justify-content-between">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                                ...
                                <div class="card-body">
                                    @can('Add Role')
                                    <a class="button x-small" href="{{ route('roles.create') }}" > {{ trans('Roles_trans.add_role') }}</a>
                                    @endcan
                                </div>
                        </div>
                    </div>
                    ...
                    <table class="table mg-b-0 text-md-nowrap table-hover ">
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('Roles_trans.Processes') }}</th>
                            </tr>
                        </thead>
                        <tbody>
