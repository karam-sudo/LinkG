                            ...
                            <div class="tab-content">
                                <div class="tab-pane  active show" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                        <div class="card-body">
                                            <form method="post" action="{{route('Upload_Employee_attachment')}}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="Employee_name" value="{{Str::slug($Employees->getTranslation('Name','en'))}}">
                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            <tbody>
                                                @foreach($Employees->images as $attachment)
                                                <tr style='text-align:center;vertical-align:middle'>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <button class="btn btn-info btn-sm">
                                                            <?php $Employeename=Str::slug($attachment->imageable->getTranslation('Name','en')) ?> 
                                                            <a 
                                                               href="{{url('Download_service_attachment')}}/{{$Employeename}}/{{$attachment->filename}}">
                                                ...
                                                @include('pages.Employees.Delete_img')
                                                @endforeach
                                            </tbody>
                                        </table>
                                    </div>
