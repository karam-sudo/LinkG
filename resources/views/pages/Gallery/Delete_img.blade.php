    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('Delete_Gallery_attachment')}}" method="post">
                    @csrf
                    <input type="hidden" name="id" value="{{$attachment->id}}">

                    <input type="hidden" name="Gallery_desc" value="{{Str::slug($attachment->imageable->getTranslation('Description','en'))}}">
                    <input type="hidden" name="Gallery_id" value="{{$attachment->imageable->id}}">
